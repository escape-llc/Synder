...
public class SyndEntryImpl implements Serializable, SyndEntry {
	...
	static {
		...
		CONVENIENCE_PROPERTIES = Collections.unmodifiableSet(new HashSet<String>());
		// must ignore; it's a recursive link
	...
	private ObjectBean getObjBean() {
		if (_objBean == null)
			_objBean = new ObjectBean(beanClass, this, IGNORE_PROPERTIES);
		return _objBean;
	}
	/**
	 ...
	 * Atom processor maps {atom}id element to this field.
	 * <p>
	...
	public List<SyndContent> getContents() {
		return (_contents == null) ? (_contents = new ArrayList<SyndContent>(CAPACITY)) : _contents;
	}
	/**
	...
	public List<SyndEnclosure> getEnclosures() {
		return (_enclosures == null) ? (_enclosures = new ArrayList<SyndEnclosure>(CAPACITY)) : _enclosures;
	}
	/**
