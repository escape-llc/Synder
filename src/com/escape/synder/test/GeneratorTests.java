 ...
 */
package com.escape.synder.test;
...
import com.escape.synder.Context;
import com.escape.synder.DefaultContext;
import com.escape.synder.DefaultParseContext;
import com.escape.synder.generators.DefaultGenerateContext;
import com.escape.synder.generators.xmlpull.GenerateXmlPull;
...
public class GeneratorTests {
	...
	static {
		try {
			PATH = new File(".").getCanonicalPath() + "/src/com/escape/synder/test/";
